...
// TMDB rejects requests for page > 500 regardless of the real result count —
// this mirrors TMDB's own ceiling, not an artificial cost-driven cap.
export const TMDB_PAGE_MAX = 500;
